      ...
      const mockData: AnalyticsData = {
        ...
        dailyAnalytics: {
          userRegistrations: Array.from({ length: timeRange }, (_, i) => ({
            date: new Date(
              Date.now() - (timeRange - i - 1) * 24 * 60 * 60 * 1000
            )
              .toISOString()
              .split("T")[0],
          ...
          topAuthors: [
            {
              userId: "user_789",
              bookCount: 12,
              "user.username": "mike_author",
            },
            {
              userId: "user_101",
              bookCount: 8,
              "user.username": "emma_stories",
            },
          ],
          topFollowers: [
            {
              following_id: "user_202",
              followerCount: 156,
              "following.username": "alex_reader",
            },
            {
              following_id: "user_303",
              followerCount: 134,
              "following.username": "lisa_bookworm",
            },
          ],
        },
        distributions: {
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsData.overallStats.totalUsers.toLocaleString()}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsData.overallStats.totalBooks.toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsData.overallStats.totalComments.toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsData.overallStats.totalFollowers.toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Daily new user registrations over {timeRange} days
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart
                    data={analyticsData.dailyAnalytics.userRegistrations}
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">
                    {analyticsData.summary.averageBooksPerUser}
                  </div>
                  <div className="text-sm text-gray-600">Books per User</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">
                    {analyticsData.summary.averageChaptersPerBook}
                  </div>
                  <div className="text-sm text-gray-600">Chapters per Book</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">
                    {analyticsData.summary.averageCommentsPerChapter}
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {analyticsData.summary.averageFollowersPerUser}
                  </div>
                  <div className="text-sm text-gray-600">
                    Followers per User
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {analyticsData.topPerformers.topCommenters.map(
                    (commenter, index) => (
                      <div
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {analyticsData.topPerformers.topAuthors.map(
                    (author, index) => (
                      <div
                        key={author.userId}
                        className="flex items-center justify-between"
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">
                            @
                            {author["user.username"] || author.userId.slice(-3)}
                          </span>
                        </div>
                        <span className="text-sm font-medium">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {analyticsData.topPerformers.topFollowers.map(
                    (follower, index) => (
                      <div
